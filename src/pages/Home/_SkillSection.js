        ...
        <>
            <section className="skills-section mt-150 layout-space">
                <div className="container-fluid">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-12 d-flex align-items-center justify-content-center">
                            <div className="d-flex align-items-center justify-content-center gap-4">
                                ...
                                <Button text="Education" className="px-4 py-3 fw-bold btn-gray-900 btn-gray" />
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="d-flex align-items-center justify-content-between px-3 py-3 gap-3 mt-150">
